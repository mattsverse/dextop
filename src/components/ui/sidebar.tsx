...
const SIDEBAR_TOGGLE_EVENT = "dextop:sidebar-toggle"
const SIDEBAR_KEYBOARD_SHORTCUT_LABEL = "Mod+B"
...
function SidebarProvider({
  ...
  React.useEffect(() => {
    ...
    return () => window.removeEventListener(SIDEBAR_TOGGLE_EVENT, toggleSidebar)
  }, [toggleSidebar])
