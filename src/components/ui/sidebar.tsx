...
const Sidebar: Component<SidebarProps> = (props) => {
  ...
  return (
    <Switch>
      ...
      <Match when={!isMobile()}>
        <div
          class="group peer relative hidden h-full text-sidebar-foreground md:block"
          data-state={state()}
        ...
        >
          ...
          <div
            ...
            class={cn(
              "absolute inset-y-0 z-0 hidden h-full w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
              local.side === "left"
